...
path3 = '/users/savin/peeling_ovro/aug10/'
cal_file = path3+'01_calibrationtable.bcal'
...
dset = outfile.create_dataset('image',(capt,4096,4096),dtype='float32') #just stokes I
...
for intg,filename in enumerate(files):
    ...
    flagdata(vis = filename, mode='manual', spw='0:000;035;008;009;076;015,022')
    ...
    # changing phase center and appling near field correction in the direction of MRA
    fixvis(vis = ini+'af_bp.ms', phasecenter = 'J2000 10h36m0.77s 69d40m7.68s',distances='100km')
    
    #fixvis(vis = ini+'af_bp.ms', phasecenter = 'J2000 10h36m0.77s 69d40m7.68s') 
