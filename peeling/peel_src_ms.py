...
cal_file = path2+'07_calibrationtable.bcal'

# Flagging bad channels in each subband    
#flagdata(vis = filename, mode='manual', spw='0:000~028;067;068;075~078;047;048;084;086;089~098')
flagdata(vis = filename, mode='manual', spw='0:000;076')

#****** Modify above****

# Bad antennas and baselines, do not change
