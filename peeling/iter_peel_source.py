...
path2 = '/users/savin/peeling_ovro/'
...
#clean(vis=ini+'af_bp.ms', imagename = ini+'afbp_image_500', mode='mfs', imsize=[4096,4096],cell=['1.875arcmin'],niter=500, weighting= 'briggs', robust =0, stokes='I',gain = 0.05)
...
while True:
      ...
      clean(vis=ini+'af_bp.ms', imagename=ini+'af_sub_noiter', mode='mfs', imsize=[4096,4096],cell=['1.875arcmin'],niter=0, weighting= 'briggs', robust =0, stokes='I')
      imfile = ini+'af_sub_noiter.image'
      it += 1        

clean(vis=ini+'af_bp.ms', imagename=ini+'af_sub_500', mode='mfs', imsize=[4096,4096],cell=['1.875arcmin'],niter=500,  weighting= 'briggs', robust =0, stokes='I',gain = 0.05)

#os.system('rm -rf '+ini+'af_sub_noiter*')
