...
#mra5 [191.175141, 45.006377, 100e+3]
#mra1 1.226941 56.067210
#mra2 = 293.112888,69.649907
#mra3 = 229.769148, 48.155862
#mra4 = 273.391789, 70.830279


az, el, dist = [273.391789, 70.830279, 150e+3]
...
for i,b in enumerate(data1.baselines):
    ...
    new_vis = numpy.array([data1.XX.data[i],
                           data1.XY.data[i],
                           data1.YX.data[i],
                           data1.YY.data[i]])
